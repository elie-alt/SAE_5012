 ...
 */
final class Version20231218093818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD featured_image_id INT DEFAULT NULL, ADD title VARCHAR(255) NOT NULL, ADD slug VARCHAR(255) NOT NULL, ADD content LONGTEXT DEFAULT NULL, ADD featured_text VARCHAR(100) DEFAULT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP featured_image_id, DROP title, DROP slug, DROP content, DROP featured_text, DROP created_at, DROP updated_at');
    }
}
